...
try {
  ...
  if (
    ...
    !logText.includes('Suwol2D Runtime Stability v9 + Animation Mixing State Machine v10 + Timeline Usability v11 + Curve Interpolation v20 + Clipping Mask v21 smoke tests passed.') &&
    !logText.includes('Suwol2D Runtime Stability v9 + Animation Mixing State Machine v10 + Timeline Usability v11 + Curve Interpolation v20 + Clipping Mask v21 + Transform Constraint v22 smoke tests passed.')
  ) {
